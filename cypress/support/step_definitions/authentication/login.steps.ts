...
// When steps
When('I enter valid email {string}', (email: string) => {
  LoginPage.enterEmail(email);
});

When('I enter invalid email {string}', (email: string) => {
  LoginPage.enterEmail(email);
});
...
When('I enter valid password {string}', (password: string) => {
  LoginPage.enterPassword(password);
});

When('I enter invalid password {string}', (password: string) => {
  LoginPage.enterPassword(password);
});
